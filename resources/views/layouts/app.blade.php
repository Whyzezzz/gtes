            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <nav class="main-nav">
                            <!-- ***** Logo Start ***** -->
                            <a href="{{ route('catalogo') }}" class="logo">
                            ...
                            <div class="search-input">
                                <form id="search" action="{{ route('detalhes-do-jogo', ['nomeDoJogo' => 'NomeDoJogoAqui']) }}" method="GET"> <!-- Corrigir a rota do formulário -->
                            ...
                            <style>
                                ...
                                <!-- ***** Menu Start ***** -->
                                <ul class="nav">
                                    <li><a href="{{ route('catalogo') }}" class="active"><i class="fa fa-home" aria-hidden="true"></i> Home</a></li>
                                    <li><a href="{{ url('/about') }}">About</a></li>
                                    <li><a href="details.html">Details</a></li>
                                    <li><a href="{{ route('carrinho.index') }}"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Carrinho</a></li>
                                    <li class="nav-item dropdown"> <!-- Adicione a classe dropdown aqui -->
                                        @if(Auth::check())
                                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                <i class="fa fa-user" aria-hidden="true"></i>{{ Auth::user()->name }} <!-- Exibe o nome do usuário logado -->
                                            </a>
                                        ...
                                        @else
                                            <a class="nav-link" href="{{ route('register') }}"><i class="fa fa-user" aria-hidden="true"></i>Register/Login</a>
                                        @endif
                                    </li>
                                </ul>
